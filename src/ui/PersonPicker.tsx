    ...
    <div className="person-picker">
      ...
      {adding && (
        <div className="freeform">
          ...
          {question.askAddress && (
            <div className="field">
              <label>{t('ui.person.address', locale)}</label>
              <input type="text" value={address} onChange={(e) => setAddress(e.target.value)} />
              <p className="hint">{t('ui.person.addressHint', locale)}</p>
            </div>
          )}
          <button className="primary" disabled={!name.trim() || !relation} onClick={submitNew}>
